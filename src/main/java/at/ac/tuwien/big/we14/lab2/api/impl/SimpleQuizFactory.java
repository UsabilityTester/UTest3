...
public abstract class SimpleQuizFactory extends QuizFactory {
	...
	@Override
	public QuizKi createQuizKi() {
		return new StochasticKi();
	}
	
	@Override
	public QuestionManager createQuestionManager() {
		return new DefaultQuestionManager(createQuestionDataProvider());
	}
