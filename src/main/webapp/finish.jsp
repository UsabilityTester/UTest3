    ...
    <body id="winnerpage">
        ...
        <section role="main">
            ...
            <section id="roundwinner" aria-labelledby="roundwinnerheading">
                ...
                <p class="roundwinnermessage"><%=question.getGameOutcome() %></p>
            </section>
            ...
            <section id="roundinfo" aria-labelledby="roundinfoheading">
                ...
                <a id="next" href="quiz?action=restart" accesskey="n">Neues Spiel</a>
            </section>
        </section>
        ...
        $(document).ready(function() {
        	...
        	localStorage.lastGame = newDate.toLocaleDateString() + " " + newDate.toLocaleTimeString();
        });
        </script>
